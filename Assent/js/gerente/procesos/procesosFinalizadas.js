...
async function fetchData() {
    try {
        ...
        // Filtrar los datos para obtener solo aquellos con estado "completado" o "calificado"
        data = allData.filter(item => item.estado.toLowerCase() === 'completado' || item.estado.toLowerCase() === 'calificado');
...
function viewQuote(id) {
    window.location.href = (`/html/gerente/procesos/cotizaciones/comprasFinalizadas.html?id=${id}`);
}
